        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-16">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-white hover:border-white/40 transition">
          ...
          <div className="mb-12">
            <h2 className="text-xl font-semibold text-white mb-1">Stay in the loop</h2>
            <p className="text-sm text-white/50 mb-4">Monthly notes on what we&apos;re building. No spam, unsubscribe anytime.</p>
            <div className="flex gap-2">
              <input
                type="email"
                placeholder="you@company.com"
                className="border border-white/20 bg-white/[0.06] text-white placeholder-white/35 rounded-lg px-4 py-2.5 text-sm w-72 focus:outline-none focus:border-white/40 transition"
              />
              <button className="bg-white text-black rounded-lg px-5 py-2.5 text-sm font-medium hover:bg-white/90 transition">
                Subscribe
              </button>
            </div>
          </div>
